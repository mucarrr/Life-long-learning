    ...
    <Section className="pb-6 sm:pb-10">
      <>
        ...
        <div
          ...
          role="note"
        >
          <h2 className="text-xl font-semibold  sm:text-2xl lg:text-3xl mb-4 text-yellow">{a.founderTitle}</h2>
        ...
        <div className="mt-10 grid gap-6 lg:mt-14 lg:grid-cols-2 lg:gap-8">
          ...
          <article className="card-base flex flex-col p-5 sm:p-6">
            <h3 className="section-title mb-8">{a.whoTitle}</h3>
            <ul className="flex flex-1 flex-col gap-6">
